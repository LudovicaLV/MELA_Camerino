...
*********/
  final public Model Input() throws ParseException, NumberFormatException, RuntimeException, ParseException {
    ...
    ArrayList<StoreInfluence> infToStore = new ArrayList<StoreInfluence >();
    ArrayList<StorePassive> passToStore = new ArrayList<StorePassive >();
    ArrayList<StoreEnvironment> envToStore = new ArrayList<StoreEnvironment >();
